...
# 📖 [CMS Bookstore] <a name="about-project"></a>

The main purpose of the CMS Bookstore website is to further strengthen React concepts as well as provide an introduction to working with Redux.
...
Feel free to check the [issues page](https://github.com/aamir-asaram/bookstore/issues).
